...
define(['exports', 'aurelia-path', 'aurelia-pal'], function (exports, _aureliaPath, _aureliaPal) {
  ...
  function createHttpRequestMessageProcessor() {
    return new RequestMessageProcessor(_aureliaPal.PLATFORM.global.XMLHttpRequest, [timeoutTransformer, credentialsTransformer, progressTransformer, responseTypeTransformer, contentTransformer, headerTransformer]);
  }
  ...
  function trackRequestEnd(client, processor) {
    ...
    // TODO: need to figure out why _aureliaPal.DOM.createCustomElement is not exposed
  ...
  var HttpClient = exports.HttpClient = function () {
    ...
    HttpClient.prototype.send = function send(requestMessage, transformers) {
      ...
      // TODO: Promise.resolve(requestMessage) seems to terminate the promise that is started in the dataservice
      promise = new Promise((resolve, reject) => {
          //resolve(requestMessage);
          for (i = 0, ii = transformers.length; i < ii; ++i) {
            transformers[i](_this5, processor, requestMessage);
          }

          resolve(processor.process(_this5, requestMessage).then(function (response) {
